                  ...
                  <div class="container-form">
                      <form method="post" action="login.php">
                          <div class="form-item log-in">
                              <div class="table">
                                  <div class="table-cell">
                                      <input type="text" class="form-control" id="loginUserName" name="loginUserName" aria-describedby="emailHelp" style="width: 80%; cursor: pointer" placeholder="User Name" required>
                                      <input type="password" class="form-control" id="loginPassword"  name="loginPassword" style="width: 80%;cursor: pointer" placeholder="Password" required>
                        ...
                        <form method="post" action="signup.php">
                            <div class="form-item sign-up">
                                <div class="table">
                                    <div class="table-cell">
                                        <input type="text" class="form-control" id="signupUserName" name="signupUserName"  aria-describedby="emailHelp" style="width: 80%;cursor: pointer;" placeholder="User Name" required>
                                        <input type="password" class="form-control" id="signupPassword" name="signupPassword"  style="width: 80%;cursor: pointer;" placeholder="Password" required>
