...
$sql = "UPDATE `".$username."fav` SET `readorunread`='".$read."' WHERE `id` IN(".$List.")";
...
$sql = "UPDATE `".$username."fav` SET `readorunread`='".$unread."' WHERE `id` IN(".$List.")";
       ...
       if(isset($_POST['profilepicturesubmit'])){
        ...
        if(isset($_POST['movetotrashbutton'])){
          ...
          $query = "SELECT * FROM `".$username."fav` WHERE id = '".$individualid."'";
            ...
            $queryb = "DELETE FROM `".mysqli_real_escape_string($link,$username)."fav` WHERE id = '".$individualid."'";
      ...
      <div class="form__group field">
        ...
        <a class="popup__close" href="">X</a>
              ...
              <div id="sidebarItems">
                  ...
                  <button class="sidebarItembutton" id="sent" style="margin:auto;" ><a href="sent.php" style="text-decoration:none;font-weight:700;color: aliceblue;"><span style="color:orange;transform: rotate(20deg);">&#10146;</span>&nbsp;Sent</a></button>
                  <button class="sidebarItembutton" id="fav" style="margin:auto;" ><a href="fav.php" style="text-decoration:none;font-weight:700;color: aliceblue;opacity:0.5;"><span >&#10084;</span>&nbsp;Fav</a></button>
                ...
                <div class="modal fade bd-example-modal-lglg" tabindex="-1" role="dialog" aria-labelledby="mySmallModalLabel" aria-hidden="true">
                  <div class="modal-dialog ">
                    <div class="modal-content" style="background-color:black;">
                        <form method="post">
                     <button type="submit" class="glow-on-hover" name="movetotrashbutton" style="margin: 0;
  position: absolute;
  top: 50%;
  left: 50%;
  -ms-transform: translate(-50%, -50%);
  transform: translate(-50%, -50%);width:150px;margin:30px 0px 30px 20px;">Move to Trash</button>
                ...
                $inboxresult = mysqli_query($link, $displayinboxitemsquery);
                  ...
                  $inboxrows = mysqli_fetch_array($inboxresult);
                      ...
                      foreach($inboxresult as $inboxrows) {
                          $favmessage[$inboxrows['id']] = nl2br($inboxrows['message']);
                          $favsubject[$inboxrows['id']] = $inboxrows['subject'];
                          $favusername[$inboxrows['id']] = $inboxrows['username'];
                          $favdate[$inboxrows['id']] = $inboxrows['date'];
                          
                          
	               $favreadorunread[$inboxrows['id']] = $inboxrows['readorunread'];
                          
	               echo '<li id="eachemailli"><div class="eachfavemail col-md-12 '.$favreadorunread[$inboxrows['id']].'" style="color:black;height:80px;  cursor:pointer;border-bottom: 1px solid #949494;"id="'.$inboxrows['id'].'">
           ...
           <div class="fullEmailDisplay col-md-6"  style="padding-bottom:30px;">
              ...
              <div id="ifemptynodisplay">
               ...
               <p style=" font-weight:600;text-transform: capitalize;" id="fullemaillistusername"><?php  echo current($favusername) ;    ?> </p>
                    <p style="color:grey;font-size:80%;position:relative;top:-15px; font-weight:500;" id="fullemaillistdate">
                        <?php  echo current($favdate) ;    ?> </p>
               <p style="font-size:40px;font-weight:400;clear: both;" id="fullemaillistsubject"><?php  echo current($favsubject) ;    ?></p>
               ...
               <div class="col-md-12" style="margin-left:20px;margin-right:20px;margin-top:35px;color:#989eaa;font-weight:500;" >
                 ...
                 <div id="fullemaillistmessage"> <?php  echo current($favmessage) ;    ?>
                   </div>
