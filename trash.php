...
$sql = "UPDATE `".$username."trash` SET `readorunread`='".$read."' WHERE `id` IN(".$List.")";
...
$sql = "UPDATE `".$username."trash` SET `readorunread`='".$unread."' WHERE `id` IN(".$List.")";
       ...
       if(isset($_POST['profilepicturesubmit'])){
        ...
        if(isset($_POST['movetotrashbutton'])){
            ...
            $queryb = "DELETE FROM `".mysqli_real_escape_string($link,$username)."trash` WHERE id = '".$individualid."'";
...
<div class="modal fade bd-example-modal-small" tabindex="-1" role="dialog" aria-labelledby="mySmallModalLabel" aria-hidden="true">
      ...
      <div class="form__group field">
        ...
        <a class="popup__close" href="">X</a>
              ...
              <div id="sidebarItems">
                  ...
                  <button class="sidebarItembutton" id="trash" style="margin:auto;" ><a href="trash.php" style="text-decoration:none;font-weight:700;color: aliceblue;opacity:0.5;"><span>🗑️</span>&nbsp;Trash</a></button>
  ...
  transform: translate(-50%, -50%);width:150px;margin:30px auto 30px auto;">Delete Permanently</button>
                ...
                $inboxresult = mysqli_query($link, $displayinboxitemsquery);
                  ...
                  $inboxrows = mysqli_fetch_array($inboxresult);
                      ...
                      foreach($inboxresult as $inboxrows) {
                          ...
                          $trashmessage[$inboxrows['id']] = nl2br($inboxrows['message']);
	              ...
	              $trashreadorunread[$inboxrows['id']] = $inboxrows['readorunread'];
                          
	               echo '<li id="eachemailli"><div class="eachtrashemail col-md-12 '.$trashreadorunread[$inboxrows['id']].'" style="color:black;height:80px;  cursor:pointer;border-bottom: 1px solid #949494;"id="'.$inboxrows['id'].'">
           ...
           <div class="fullEmailDisplay col-md-6"  style="padding-bottom:30px;">
              ...
              <div id="ifemptynodisplay">
               ...
               <p style=" font-weight:600;text-transform: capitalize;" id="fullemaillistusername"><?php  echo current($trashusername) ;    ?> </p>
                    <p style="color:grey;font-size:80%;position:relative;top:-15px; font-weight:500;" id="fullemaillistdate">
                        <?php  echo current($trashdate) ;    ?> </p>
               <p style="font-size:40px;font-weight:400;clear: both;" id="fullemaillistsubject"><?php  echo current($trashsubject) ;    ?></p>
               ...
               <div class="col-md-12" style="margin-left:20px;margin-right:20px;margin-top:35px;color:#989eaa;font-weight:500;" >
                 ...
                 <div id="fullemaillistmessage"> <?php  echo current($trashmessage) ;    ?>
                   </div>
