    ...
    if (array_key_exists("id", $_SESSION)) {
        ...
        if(isset($_POST['newmessagesubmit'])){
            ...
            if ($rows['id']>0) {
                ...
                $querya = "INSERT INTO `".mysqli_real_escape_string($link,$_POST['newmessageusername'])."inbox` (`username`,`subject`,`message`,`date`,`time`,`readorunread`) VALUES ('".mysqli_real_escape_string($link,$username). "','".mysqli_real_escape_string($link,$_POST['newmessagesubject'])."','".mysqli_real_escape_string($link,$_POST['newmessagemessage'])."','".mysqli_real_escape_string($link,$date)."','".mysqli_real_escape_string($link,$time)."','".mysqli_real_escape_string($link,$unread)."')";
                }else{
                    $querya = "INSERT INTO `".mysqli_real_escape_string($link,$_POST['newmessageusername'])."inbox` (`username`,`subject`,`message`,`file1`,`date`,`time`,`readorunread`) VALUES ('".mysqli_real_escape_string($link,$username). "','".mysqli_real_escape_string($link,$_POST['newmessagesubject'])."','".mysqli_real_escape_string($link,_POST['newmessagemessage'])."','".mysqli_real_escape_string($link,$file_tmp_name)."','".mysqli_real_escape_string($link,$date)."','".mysqli_real_escape_string($link,$time)."','".mysqli_real_escape_string($link,$unread).")";
                }
                
                $queryb= "INSERT INTO `".mysqli_real_escape_string($link,$username)."sent` (`username`,`subject`,`message`,`file1`,`date`,`time`,`readorunread`) VALUES ('".mysqli_real_escape_string($link,$_POST['newmessageusername'])."','".mysqli_real_escape_string($link,$_POST['newmessagesubject'])."','".mysqli_real_escape_string($link, $_POST['newmessagemessage'])."','".mysqli_real_escape_string($link,$file_tmp_name)."','".mysqli_real_escape_string($link,$date)."','".mysqli_real_escape_string($link,$time)."','".mysqli_real_escape_string($link,$unread)."')";
...
$sql = "UPDATE `".$username."inbox` SET `readorunread`='".$read."' WHERE `id` IN(".$List.")";
...
$sql = "UPDATE `".$username."inbox` SET `readorunread`='".$unread."' WHERE `id` IN(".$List.")";
       ...
       if(isset($_POST['profilepicturesubmit'])){
        ...
        if(isset($_POST['movetotrashbutton'])){
          ...
          $query = "SELECT * FROM `".$username."inbox` WHERE id = '".$individualid."'";
            ...
            $queryb = "DELETE FROM `".mysqli_real_escape_string($link,$username)."inbox` WHERE id = '".$individualid."'";
...
<div class="modal fade bd-example-modal-lg row stylescrollbar" tabindex="-1" role="dialog" aria-labelledby="myLargeModalLabel" aria-hidden="true" style="width:100%;height:100%;" >
  <div class="modal-dialog modal-lg" id="thememodal" style="overflow:hidden;"  >
        ...
        <div class="row " >
          <div class="sidebar col-md-2">
              ...
              if(empty($profilepicture)){
                echo  "<img src='nodp.png' alt='HelPic' style='height:80px;width:80px; border-radius:50%;box-shadow: 0px 0px 5px #fff;margin:20px auto 20px auto;cursor:pointer;' id='profilepicimage'>";
              }else{
      ...
      <div class="form__group field">
        ...
        <a class="popup__close" href="">X</a>
              ...
              <div id="sidebarItems">
                  ...
                  <button class="sidebarItembutton" id="inbox" style="margin:auto;"> <a href="loggedinpage.php" style="text-decoration:none;font-weight:700;opacity:0.5;color:white;"><span style="color:yellow">⚡</span>&nbsp;Inbox</a></button>
                  <button class="sidebarItembutton" id="sent" style="margin:auto;" ><a href="sent.php" style="text-decoration:none;font-weight:700;color:white;"><span style="color:orange;transform: rotate(20deg);">&#10146;</span>&nbsp;Sent</a></button>
                  <button class="sidebarItembutton" id="fav" style="margin:auto;" ><a href="fav.php" style="text-decoration:none;font-weight:700;color:white;"><span >&#10084;</span>&nbsp;Fav</a></button>
                  <button class="sidebarItembutton" id="trash" style="margin:auto;" ><a href="trash.php" style="text-decoration:none;font-weight:700;color:white;"><span>🗑️</span>&nbsp;Trash</a></button>
  ...
  text-shadow: 0px 0px 0px transparent;" id="markasunread" name="markasunread" >Mark as unread</button> </a></li></form>
                ...
                $inboxresult = mysqli_query($link, $displayinboxitemsquery);
                  ...
                  $inboxrows = mysqli_fetch_array($inboxresult);
                      ...
                      foreach($inboxresult as $inboxrows) {
                           ...
                           $inboxmessage[$inboxrows['id']] = nl2br($inboxrows['message']);
                          ...
                          $inboxtime[$inboxrows['id']] = $inboxrows['time'];
                          $inboxreadorunread[$inboxrows['id']] = $inboxrows['readorunread'];
                          
	               echo '<li id="eachemailli"><div class="eachinboxemail col-md-12 '.$inboxreadorunread[$inboxrows['id']].'" style="color:black;height:80px;  cursor:pointer;border-bottom: 1px solid #949494;"id="'.$inboxrows['id'].'">
           ...
           <div class="fullEmailDisplay col-md-6"  style="padding-bottom:30px;">
              ...
              <div id="ifemptynodisplay">
                ...
                <p style="position:relative; font-weight:600;text-transform: capitalize;" id="fullemaillistusername"><?php  echo current($inboxusername) ;    ?> </p>
                    <p style="color:grey;font-size:80%;position:relative;top:-15px; font-weight:500;" id="fullemaillistdate">
                        <?php  echo current($inboxdate) ;    ?> </p>
               <p style="font-size:40px;font-weight:400;clear: both;" id="fullemaillistsubject"><?php  echo current($inboxsubject) ;    ?></p>
               ...
               <div class="col-md-12" style="margin-left:20px;margin-right:20px;margin-top:35px;color:#989eaa;font-weight:500;" >
                 ...
                 <div id="fullemaillistmessage"> <?php  echo current($inboxmessage) ;    ?>
                   </div>
...
?>
      ...
      <script type="text/javascript">
          ...
          var inboxreadorunreadarray = <?php echo json_encode($inboxreadorunread); ?>;
